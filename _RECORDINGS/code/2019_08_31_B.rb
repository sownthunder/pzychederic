...
pete_snack = "C:/Users/dbates/BoxPeteSnacks Sub Sapler Vol. 3/Subs/"

#THPS_samples - "/D/SOUNDS/THPS/"
...
with_fx :reverb, mix: 0.4 do
  with_fx :echo, mix: 0.7 do
    ...
    #sample THPS_samples, "bustvalve.wav", rate: 1, amp: 8
    sample pete_snack, "PeteSnacks Froggy Sub E.wav", rate: 1, amp: 8
    sleep 3
    #sample dubstep_toms, "Tom (9).wav", rate: 1, amp: 6
    #sample THPS_samples, "wheels01.wav", rate: 1, amp: 6
    sleep 1
  end
end
