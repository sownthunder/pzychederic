...
klub_samples = "/Users/dbates/Box/DRUM_KITS/DnB_Klub_Kit/"

C64_samples = "/Users/dbates/Box/DRUM_KITS/C64 Drum Kit/"
...
with_fx :reverb, mix: 0.4 do
  with_fx :echo, mix: 0.7 do
    ...
    #OLD#sample dubstep_toms, "Tom (3).wav", rate: 1, amp: 8
    sample klub_samples, "chbb34.wav", rate: 3, amp: 8
    sleep 3
    #sample :ambi_lunar_land, rate: 2
    #sample dubstep_toms, "Tom (9).wav", rate: 1, amp: 6
    sample klub_samples, "chbb36.wav", rate: 3, amp: 8
    sleep 1
  end
end
...
live_loop :rummut do
  ...
  sample C64_samples, "cowbell", amp: 2
  sleep 0.5
  #sample :bd_klub, amp: 2, rate: 1.25
  sample C64_samples, "kick  7", rate: 1.25
  sleep 0.25
  #sample :bd_ada, amp: 1.5
  sample C64_samples, "kick 1", amp: 1.25
  sleep 0.25
  with_fx :reverb, mix: 0.2, decay: 1 do
    #sample :sn_dolf, amp: 1.75
    sample C64_samples, "snare 1", amp: 1.75
  end
  sleep 0.25
  #sample :bd_pure, amp: 1.5
  sample C64_samples, "kick 8", amp: 2
  sleep 0.75
  #sample :bd_ada, amp: 2
  #OLD#sample dubstep_fx, "Effect 3", amp: 3
  with_fx :reverb, mix: 0.7 do
    sample C64_samples, "kick 4", amp: 4
  end
  
  sleep 1
  with_fx :reverb, mix: 0.2, decay: 1 do
    #sample :drum_snare_soft, amp: 2
    sample C64_samples, "snare 2", amp: 2 ## WAS: 100
