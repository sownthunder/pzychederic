...
live_loop :biitti do
  ...
  sample dubstep_kicks, "Kick   (16)", rate: 1, amp: 8
  sleep 1
...
live_loop :hihat do
  16.times do
    sample dubstep_hihats, "Hi Hats (85)", start: 0.05, finish: 0.4, rate: 3, amp: 1 + rrand(-0.1, 0.1)
    sleep 0.125
  end
  4.times do
    sample dubstep_hihats, "Hi Hats (86)", start: 0.05, finish: 0.6, rate: 3, amp: 1 + rrand(-0.1, 0.1)
    sleep 0.25
  end
  16.times do
    sample dubstep_hihats, "Hi Hats (98)", start: 0.1, finish: 0.3, rate: 3, amp: 1 + rrand(-0.1, 0.1)
    sleep 0.0625
  end
end