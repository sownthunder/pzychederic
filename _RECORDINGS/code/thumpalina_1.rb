...
blue_drums = "/Users/dbates/Box/DRUM_KITS/blu.drum.kit/Snare"
...
live_loop :biitti do
  ...
  sample blue_drums, "Snare 3", rate: 1, amp: 8
  sleep 0.5
  sample trippy_nation, "AB_808-01.wav", rate: 1, amp: 8
  sleep 1
...
live_loop :luuppi do
  sample :loop_breakbeat, beat_stretch: 6, attack: 0.9, rate: 0.4
  sleep 5
end
