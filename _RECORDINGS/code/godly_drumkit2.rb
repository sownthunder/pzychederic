...
live_loop :rummut do
  ...
  sample godly_drums, "Chopped Drums - kick 3 godly", amp: 1
  sleep 1
  ##sample :drum_snare_hard
  sample godly_drums, "Chopped Drums - snare 5 godly", amp: 1
  sleep 1
  ##sample :drum_heavy_kick
...
live_loop :hihat do
  ...
  sample godly_drums, "Chopped Drums - hi hat 2 godly", amp: 1
  sleep 1
end
