...
clap_samples = "/Users/dbates/Box/DRUM_KITS/Dubstep Empire Drum Kit/Claps/"
bass_samples = "C:/Users/dbates/Box/DRUM_KITS/Dubstep Empire Drum Kit/Kicks/"
        ...
        at [0.5, 2.5, 4.5, 6.5] do
          with_fx :panslicer, mix: 1, wave: 3 do
            with_fx :reverb, mix: 0.6, room: 0.2, amp: 2 do
              ...
              sample bass_samples, "Kick   (5).wav", rate: n, amp: 1
            end
          end
        end
        sleep 8
