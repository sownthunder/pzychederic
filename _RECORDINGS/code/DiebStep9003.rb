...
with_fx :distortion, mix: 0.08 do
  with_fx :nrhpf, mix: 0.05 do
    ...
    live_loop :drumloop do
      at [1, 2, 4] do
        sample "BASS-WaspyBass", amp: rrand(1, 1.5), rate: rrand(0.95, 1.05)
      end
      at [2.5, 6.5] do
        ...
        3.times do
          at [0.5, 2.5, 4.5] do
            with_fx :panslicer, smooth_up: 0.1, smooth_down: 0.1 do
              ...
              sample "BASS-PWMblaster", pitch: 0, finish: 0.6
            end
          end
          at [6.5] do
            with_fx :panslicer, smooth_up: 0.1, smooth_down: 0.1 do
              sample :bass_dnb_f, pitch: 0, finish: 0.6
              ##sample "BASS-OlympicSkierBass", pitch: 0, finish: 0.6
            end
          end
          sleep 8
        end
          ...
          with_fx :panslicer, mix: 1, wave: 3 do
            with_fx :reverb, mix: 0.6, room: 0.2, amp: 2 do
              7.times do
                ...
                ##sample "BASS-OlympicSkierBass", rate: n, finish: 0.1
                n += 0.15
                sleep 0.25
              end
