...
with_fx :reverb, mix: 0.4 do
  with_fx :echo, mix: 0.7 do
    ...
    sample dubstep_fx, "FX (18)", amp: 2
    sleep 3
    #sample :ambi_lunar_land, rate: 2
    sample dubstep_fx, "FX (9)", rate: 2
    sleep 1
  end
end
...
live_loop :rummut do
  ...
  sample dubstep_kicks, "Kick   (26)", amp: 2
  sleep 0.5
  #sample :bd_klub, amp: 2, rate: 1.25
  sample dubstep_kicks, "Kick   (26)", rate: 1.25
  sleep 0.25
  sample :bd_ada, amp: 1.5
  sleep 0.25
  with_fx :reverb, mix: 0.2, decay: 1 do
    #sample :sn_dolf, amp: 1.75
    sample dubstep_snares, "Snare (10)", amp: 1.75
  end
  sleep 0.25
