...
live_loop :rummut do
  ...
  sample retro_kicks, "Kick_19.wav", amp: 3
  sleep 1
  with_fx :reverb, mix: 0.2, decay: 1 do
    #sample :drum_snare_soft, amp: 2
    sample retro_snares, "Snare_40", amp: 2 ## WAS: 100
