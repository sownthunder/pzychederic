...
alesis_samples = "/Users/dbates/Box/DRUM_KITS/Dubstep Empire Drum Kit/SS Alesis D-4 Samples/"


#### 80s RETRO ########
bit_samples = "/Users/dbates/Box/80s_Retro_boi/8 bits/"
retro_percussion = "/Users/dbates/Box/80s_Retro_boi/Percussion/"
retro_snares = "/Users/dbates/Box/80s_Retro_boi/Snares"
retro_toms = "/Users/dbates/Box/80s_Retro_boi/Toms/"
retro_808s = "/Users/dbates/Box/80s_Retro_boi/808/"
retro_kicks = "/Users/dbates/Box/80s_Retro_boi/Kicks/"
...
with_fx :reverb, mix: 0.4 do
  with_fx :echo, mix: 0.7 do
    ...
    sample bit_samples, "SynthTom01.wav", rate: 1, amp: 8
    sleep 3
    #sample :ambi_lunar_land, rate: 2
    sample bit_samples, "SynthTom03.wav", rate: 1, amp: 6
    sleep 1
  end
end
...
live_loop :rummut do
  ...
  sample retro_kicks, "Kick_21", amp: 2
  sleep 0.5
  #sample :bd_klub, amp: 2, rate: 1.25
  sample retro_kicks, "Kick_19", rate: 1.25
  sleep 0.25
  #sample :bd_ada, amp: 1.5
  #OLD#sample alesis_samples, "MaxV - Kick", amp: 1.25
  sample retro_kicks, "Kick_17.wav", amp: 1.25
  sleep 0.25
  with_fx :reverb, mix: 0.2, decay: 1 do
    #sample :sn_dolf, amp: 1.75
    sample retro_snares, "Snare_40", amp: 1.75
  end
  sleep 0.25
  #sample :bd_pure, amp: 1.5
  #sample dubstep_kicks, "Kick   (20)", amp: 2
  #sample dubstep_kicks, "Kick   (42)", amp: 2
  sample retro_kicks, "Kick_25.wav", amp: 2
  sleep 0.75
  #sample :bd_ada, amp: 2
  #USE#sample dubstep_fx, "Effect 3", amp: 3
  sample retro_kicks, "Kick_33.wav", amp: 3
  sleep 1
  with_fx :reverb, mix: 0.2, decay: 1 do
    #sample :drum_snare_soft, amp: 2
    sample retro_snares, "Snare_20", amp: 2 ## WAS: 100
...
live_loop :bassolinja2, delay: 32 do
  #use_synth :zawa
  #use_synth :dpulse
  #USE#use_synth :pretty_bell
  use_synth :piano # WAS MOD_FX
