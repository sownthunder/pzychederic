...
with_fx :reverb, mix: 0.4 do
  with_fx :echo, mix: 0.7 do
    ...
    sample dubstep_percuss, "Percussions (17).wav", rate: 1, amp: 8
    sleep 3
    #sample :ambi_lunar_land, rate: 2
    sample dubstep_fx, "Effect 1.wav", rate: 1, amp: 8
    sleep 1
  end
end
...
live_loop :rummut do
  ...
  sleep 0.75
  #sample :bd_ada, amp: 2
  sample dubstep_fx, "Effect 3", amp: 2
  sleep 1
  with_fx :reverb, mix: 0.2, decay: 1 do
    #sample :drum_snare_soft, amp: 2
    sample dubstep_snares, "Snare (100)", amp: 2
  end
  sleep 1
end
